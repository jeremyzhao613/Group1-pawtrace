...
| User research, surveys, validation reports, interview notes | `docs/validation-report/` |
...
Do not add loose PDFs, DOCX files, survey spreadsheets, screenshots, logs, generated builds, or local testing artifacts to the root.
