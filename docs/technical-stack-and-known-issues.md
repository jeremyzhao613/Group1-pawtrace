...
> See `docs/project-structure.md` for the detailed sub-folder map.
...
- README: `Group1-pawtrace-main/Group1-pawtrace-main/README.txt`
- Project structure: `Group1-pawtrace-main/Group1-pawtrace-main/docs/project-structure.md`
- Cloudflare deployment: `docs/cloudflare-deployment.md`
- M5Stack telemetry: `docs/pawtrace-m5stack-telemetry.md`
- Desktop EXE packaging: `docs/pawtrace-desktop-exe.md`
- Mobile packaging: `docs/pawtrace-mobile-packaging.md` and `docs/pawtrace-release-packaging.md`
- Release notes: `plans/pawtrace-4.0.1.plan.md` → `plans/pawtrace-10.1.0.md`
- Architecture diagram source: `architecture-diagram.mmd` (render at <https://mermaid.live> and export PNG)

---

_Last updated: 2026-05-14 · Document curated from README.txt, the `plans/` release-notes folder, and the architecture diagram._
