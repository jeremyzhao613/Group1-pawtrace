...
- `plans/archive/pawtrace-10.1.0-duplicate-no-extension.md`（无扩展名重复稿已归档为 `.md`）
...
- `10.1.0md` 无扩展名重复版本已整理到 `plans/archive/pawtrace-10.1.0-duplicate-no-extension.md`；规范版本保留为 `plans/pawtrace-10.1.0.md`。
...
- `plans/pawtrace-10.1.0.md`, `plans/archive/pawtrace-10.1.0-duplicate-no-extension.md`
...
- The duplicate no-extension `10.1.0md` copy has been archived as `plans/archive/pawtrace-10.1.0-duplicate-no-extension.md`; the canonical file is `plans/pawtrace-10.1.0.md`.
