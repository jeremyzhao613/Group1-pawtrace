...
- **版本类型**：大更新，`+0.1.0`
- **发布状态**：已存在 `v8.9.0` tag，当前指向合并包提交前的 `6d2212e`；本次合并包文档作为后续补充提交，未移动既有 tag
...
- 新增 `plans/pawtrace-8.2.0-8.9.0.md`，将 8.2.0 到 8.9.0 的设备遥测、实时地图、Glass Dashboard、Monitor、Video Behavior Check 和交付文档更新打包成合并发布说明。
