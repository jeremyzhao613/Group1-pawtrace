...
- 删除旧的单版本 8.2.0 到 8.9.0 文档：
  - `plans/pawtrace-8.2.0.md`
  - `plans/pawtrace-8.3.0.md`
  - `plans/pawtrace-8.4.0.md`
  - `plans/pawtrace-8.5.0.md`
  - `plans/pawtrace-8.6.0.md`
  - `plans/pawtrace-8.7.0.md`
  - `plans/pawtrace-8.8.0.md`
  - `plans/pawtrace-8.9.0.md`
- 8.2.0 - 8.9.0 的版本叙事保留在合并包：
  - `plans/pawtrace-8.2.0-8.9.0.md`
